...
var buttonsService = document.querySelectorAll('.services__button');
var navMenuIcon = document.querySelector('.nav-menu-icon');
var body = document.body;
var navMenu = document.querySelector('.nav-menu');
var nav = document.querySelector('.nav');
var list = document.querySelector('.list');
var hiddenMenu = document.querySelector('.nav-menu__nav-hidden');
var navMenuLink = document.querySelector('.nav-menu__link');
...
var switcher = function switcher() {
  ...
  var getElements = function getElements(type) {
  ...
  var extractId = function extractId(targetNode, baseClass) {
  ...
  var showTarget = function showTarget(targets, targetId) {
...
switcher();
var test = window.getComputedStyle(body).width;
console.log(test);
...
buttonsService.forEach(function (button) {
  button.addEventListener('click', function () {
    buttonsService.forEach(function (i) {
